          ...
          <div className="framer-divs-center">
            <div className="framer-left">
              ...
              <p className="subtitle-about">
                ...
                Akira Toriyama en 1984 como un manga. La historia se inspira en
                la novela china Viaje al Oeste y sigue a Goku, un niño con cola
                de mono que tiene habilidades extraordinarias. Goku fue criado
                en las montañas por su abuelo adoptivo, Gohan, quien le enseñó
                artes marciales.
                <br /> <br />
                <p>
                  {" "}
          ...
          <div className="content-parents border-div padding-max-about flex-column flex-column-mobile">
            <div className="div-left ">
              ...
              <p className="button-spacing subtitle-about margin-bottom-min margin-top-min">
                ...
                camino, Gokū entrena en artes marciales, participa en torneos y
                enfrenta a villanos como el Emperador Pilaf y Piccolo. La serie
                mezcla acción, humor y aventuras.
              </p>
            </div>
          ...
          <div className="content-parents border-div padding-max-about-z column-mobile  flex-column-reverse">
            ...
            <div className="div-right padding-min">
              ...
              <p className="button-spacing subtitle-about margin-bottom-min margin-top-min">
                ...
                la Tierra de poderosos enemigos, como los Saiyajins, Freezer,
                los Androides, Cell y Majin Buu. A lo largo de la serie, los
                personajes enfrentan batallas épicas, alcanzan nuevas
                transformaciones como el Super Saiyajin, y exploran otros
                planetas y dimensiones, siempre luchando para proteger al
                universo.
              </p>
            </div>
          </div>
        ...
        <div className="parents margin-top-about-mobile" id="about">
          <div className="content-parents border-div padding-max-about column-mobile flex-column-reverse">
            ...
            <div className="div-right padding-min">
              ...
              <p className="button-spacing subtitle-about margin-bottom-min margin-top-min">
                Tras la derrota de Majin Buu. La serie introduce nuevos enemigos
                y aliados, como Bills, el Dios de la Destrucción, y Goku Black,
                un misterioso villano. Gokū y Vegeta alcanzan nuevas
                transformaciones, como el Super Saiyajin Blue y el Ultra
                Instinto. Además, participan en el Torneo del Poder, donde
                luchan por la supervivencia de su universo contra los mejores
                guerreros de otros universos.
              </p>
            </div>
          </div>
        </div>{" "}
